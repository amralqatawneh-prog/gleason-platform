...
- P6.C3 Calibration & Fixture Laboratory is **OWNER-VERIFIED / REFINEMENT IN PROGRESS** on draft PR #39 from the PR #38 merge baseline. The original nine-fixture laboratory passed owner manual 6/6 on `acb232c9…` after #904. The lower-resolution map is now an owner-approved visual/ruler reference; explicit English/statute and historical nautical/geographical metre-per-mile profiles are exposed while JGW native units/CRS remain unknown. Contract: `docs/PHASE_6_P6_C3_CALIBRATION_FIXTURE_LABORATORY.md`.
