# Navigation and measurement requirements — updated 2026-09-22

Status: P5.6 navigation is CLOSED. Phase 5 is ACCEPTED BY OWNER at v0.5.0. Phase 6 is in progress; **P6.1–P6.6 are CLOSED**. **P6.7A Same Route, Three Renderings is IN PROGRESS** on draft PR #34 from `main @ 1825852da81c04cee8e5b9f73dba28b55068c000`; **P6.7B remains NOT STARTED**.
Source: owner requirements, accepted Phase 5 records, and explicit instruction «ابدأ بتنفيذ Phase 6».
Sequential execution remains enforced: P6.1–P6.6 are closed; P6.2 continues to own the single transient ordered route state; P6.7A now owns same-route/three-rendering behavior while preserving the selected computation identity; P6.7B remains reserved for dedicated RouteProvider/turn-by-turn navigation.
...
- P6.6 polygon/perimeter/area operations: **CLOSED / VERIFIED / MERGED** through PR #31.
- P6.7A same route / three renderings: **IN PROGRESS** on `feat/p6.7a-same-route-three-renderings`, draft PR #34.
...
The dedicated future `RouteProvider` remains unavailable until P6.7B. P6.7A reuses the canonical P6.2 route and keeps computation identity separate from visualization identity. P6.5 Gleason distance uses normalized model units with no automatic SI conversion; P6.6 perimeter/area is closed under the explicit polygon semantics contract. The approved architecture amendment is documented in
