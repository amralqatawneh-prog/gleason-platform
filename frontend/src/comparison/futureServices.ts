...
export const FUTURE_SERVICE_CONTRACTS: readonly Readonly<FutureServiceContract>[] = Object.freeze([
  ...
  Object.freeze({
    ...
    status:'unavailable',
    plannedPhase:'6',
    currentBoundary:'P6.3 implements WGS84 distance, P6.4 AE distance, P6.5 Gleason normalized distance, and P6.6 implements model-specific polygon perimeter/area in the measurement engine. This future route-provider contract remains unavailable for provider-backed road/flight paths and turn-by-turn directions.',
    availableOperations:Object.freeze([]),
  }),
]);
