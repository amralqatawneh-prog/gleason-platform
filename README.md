...
- Owner-approved **Roadmap & Astronomy Architecture Amendment** is now **IN PROGRESS (documentation/architecture only)** on `docs/astronomy-roadmap-amendment-2026-09-21`; it expands future Phases 9–12, 17 and 20, registers comparative/historical astronomy sources, and reserves `CelestialComputationProvider` / `EclipsePredictionProvider`. P6.6 remains **NOT STARTED**.
