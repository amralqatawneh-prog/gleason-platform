...
> State Persistence is now IN PROGRESS.** Phase 6 measurement/routing is
> also NOT STARTED.
...
| P5.8 | IN PROGRESS 🚧 | Versioned local state persistence |
...
P5.8 is implementing schema-versioned IndexedDB persistence for the canonical
...
- P5.8 persistence/restoration is currently being implemented and is not yet accepted.
